...
export function PortfolioPage() {
  ...
  return (
    <div id="top" className="min-h-screen bg-background text-foreground">
      ...
      <footer className="flex flex-col gap-5 bg-foreground px-6 py-8 text-background sm:flex-row sm:items-center sm:justify-between sm:px-10 lg:px-16"><span className="font-semibold">Krishna H</span><span className="text-sm opacity-60">Designed and built with care · 2026</span><div className="flex gap-5"><a href={site.linkedin} target="_blank" rel="noreferrer" aria-label="LinkedIn"><Linkedin size={18} /></a><a href={site.github} target="_blank" rel="noreferrer" aria-label="GitHub"><Github size={18} /></a><a href={site.youtube} target="_blank" rel="noreferrer" aria-label="YouTube" className="text-sm font-medium">YouTube</a></div></footer>
    </div>
  )
}
